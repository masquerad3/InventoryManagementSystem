namespace EmployeeDragDrop
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnFilterEmployee = new CuoreUI.Controls.cuiButton();
            label2 = new Label();
            ...
            // cuiPanel1
            // 
            cuiPanel1.Controls.Add(btnFilterEmployee);
            ...
            cuiPanel1.Size = new Size(858, 432);
            cuiPanel1.TabIndex = 4;
            // 
            // btnFilterEmployee
            // 
            btnFilterEmployee.BackColor = Color.Transparent;
            btnFilterEmployee.CheckButton = false;
            btnFilterEmployee.Checked = false;
            btnFilterEmployee.CheckedBackground = Color.FromArgb(255, 106, 0);
            btnFilterEmployee.CheckedForeColor = Color.White;
            btnFilterEmployee.CheckedImageTint = Color.White;
            btnFilterEmployee.CheckedOutline = Color.FromArgb(255, 106, 0);
            btnFilterEmployee.Content = "Filter";
            btnFilterEmployee.DialogResult = DialogResult.None;
            btnFilterEmployee.Font = new Font("Microsoft Sans Serif", 9.75F);
            btnFilterEmployee.ForeColor = Color.Black;
            btnFilterEmployee.HoverBackground = Color.DodgerBlue;
            btnFilterEmployee.HoveredImageTint = Color.White;
            btnFilterEmployee.HoverForeColor = Color.Black;
            btnFilterEmployee.HoverOutline = Color.FromArgb(32, 128, 128, 128);
            btnFilterEmployee.Image = null;
            btnFilterEmployee.ImageAutoCenter = true;
            btnFilterEmployee.ImageExpand = new Point(0, 0);
            btnFilterEmployee.ImageOffset = new Point(0, 0);
            btnFilterEmployee.Location = new Point(525, 33);
            btnFilterEmployee.Name = "btnFilterEmployee";
            btnFilterEmployee.NormalBackground = Color.DeepSkyBlue;
            btnFilterEmployee.NormalForeColor = Color.Black;
            btnFilterEmployee.NormalImageTint = Color.White;
            btnFilterEmployee.NormalOutline = Color.FromArgb(64, 128, 128, 128);
            btnFilterEmployee.OutlineThickness = 1F;
            btnFilterEmployee.PressedBackground = Color.WhiteSmoke;
            btnFilterEmployee.PressedForeColor = Color.FromArgb(32, 32, 32);
            btnFilterEmployee.PressedImageTint = Color.White;
            btnFilterEmployee.PressedOutline = Color.FromArgb(64, 128, 128, 128);
            btnFilterEmployee.Rounding = new Padding(8);
            btnFilterEmployee.Size = new Size(130, 32);
            btnFilterEmployee.TabIndex = 5;
            btnFilterEmployee.TextAlignment = StringAlignment.Center;
            btnFilterEmployee.TextOffset = new Point(0, 0);
            btnFilterEmployee.Click += btnFilterEmployee_Click_1;
            // 
            // label2
            // 
        ...
        private CuoreUI.Controls.cuiButton btnFilterEmployee;
    }
}
